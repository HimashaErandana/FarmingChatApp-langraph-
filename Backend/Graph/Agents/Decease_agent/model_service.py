...
class ModelService:
    ...
    def __init__(self):
        ...
        with open("Graph\Agents\Decease_agent\class_indices.json", "r") as f:
    ...
    def getService(self,img_path):
        ...
        if self.model is None:
            self.model = load_model("Graph/Agents/Decease_agent/plant_disease_resnet50_final.keras", compile=False)
